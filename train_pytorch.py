...
def fit_one_epoch(model, train_loader, batch_transforms, optimizer, scheduler, amp=False, log=None):
    ...
    for images, targets in pbar:
        ...
        if isinstance(scheduler, torch.optim.lr_scheduler.ReduceLROnPlateau):
            scheduler.step(train_loss)  # train_loss harus didefinisikan sebelumnya
        else:
            scheduler.step()
    ...
    if isinstance(args.train_path, str):
        ...
        train_set = RecognitionDataset(
            ...
            img_transforms=Compose([
                ...
                # T.RandomApply(GaussianBlur(kernel_size=3, sigma=(0.5, 1.5)), p=0.3),
...
def parse_args():
    ...
    parser.add_argument("--optim", type=str, default="adam", choices=["adam", "adamw", "sgd"], help="optimizer to use")
    parser.add_argument(
        "--sched", type=str, default="cosine", choices=["cosine", "onecycle", "poly", "reduce", "step"], help="scheduler to use"
    )
